...
jsPsych.plugins['html-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if(trial.slider_number){
      html += '<div class="font-weight-bold text-primary ml-2 valueSpan" style="vertical-align: top; width: 107%; text-align: right; position: relative; top: 25px; z-index: -1;"></div>';
    }
